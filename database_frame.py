...
class databaseFrame(Frame):
    ...
    def __init__(self, master, display, parent, canvas, menu):
        ...
        self.consumer = Pmw.EntryField(search_pane2, labelpos=W, label_text='Consumer Number', validate='numeric', command=self.activate_searchbtn)
        ...
        self.year.set(2019)
        self.btn3 = Button(search_pane2, text='Search', state=DISABLED, command=self.search_db)
        self.btn3.pack(side=LEFT)
        self.btn4 = Button(search_pane2, text='Clear', state=DISABLED, command=self.clear_display)
        self.btn4.pack(side=LEFT)

    def activate_searchbtn(self):
